      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:h-[600px]">
          ...
          <div className="lg:w-2/5 ">
            <Card className="h-full bg-[#ccb9ad]">
              <CardContent className="p-6 h-full flex flex-col">
                ...
                {!showResults ? (
                  ...
                  <div className="flex-1 flex flex-col bg-[#ccb9ad]">
                      ...
                      {jointFillerProducts.map((product) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <p className="text-black text-xs font-semibold">{requiredQty.toFixed(2)} Kg Required</p>
                          </div>
                        )
                      })}
                    </div>
                    ...
                    <div className="mt-3 pt-3 border-t">
                      <p className="text-xs text-black text-center mb-2 leading-tight">
