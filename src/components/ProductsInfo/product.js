...
export const tileAdhesive = [
  {
    ...
    scope: "GeoGres G-11 is a tile adhesive designed for Gres tiles and glazed terracotta, Indoor use, On horizontal and vertical, On cement and cement-lime, Cement screeds and concrete",
    itemNo: "G-11"
...

  {
    ...
    scope: "GeoGres G-21 is a tile adhesive designed for vitrified tiles and glazed terracotta, Indoor use,On horizontal and vertical, On cement and cement-lime, Cement screeds and concrete",
    itemNo: "G-21",
  },

  {
    ...
    scope: "GeoGres G-31 adhesive mortar for layramic tile  vitrified (semi and fully) tiles and al stone (non sensitive & color fast),Indoors and Outdoors.,GeoGres S-31mortars can be used in room exposed to water.,It is recommended for floors with elevated functional loads in shopping malls staircas.",
    itemNo: "G-31",
  },

  {
    ...
    usage: "Tile Adhesive for underwater, Interior & Exterior floor and wall Applications for Medium and Heavy tiles and stones",
    bg: "#CB5533",
    ...
    scope: "GeoGres G-41 is used to laying vitrified tilles (semi and fully) cement and stone tihus large format and heavy duty tiles thin tiles., Its features keep elastic connection with substrate which allowed to carry over shear stresses between tile and substrate., On horizontal and vertical surface - Polymer Modified Bonds with various substrates",
    itemNo: "G-41",
  },
    ...
    scope: "GeoGres G-51 is used to laying vitrified tiles (semi and fully) cement and stone tiles large format and heavy duty tiles thin tiles., Its features keep elastic connection with substrate which allowed to carry over shear stresses between tile and substrate., On horizontal and vertical surfaces",
    itemNo: "G-51",
  },
]
...
export const epoxyGrout =[
  {
    ...
    hardnerImg: "https://res.cloudinary.com/dzvwqhzgf/image/upload/v1761303374/Hardner_1_Kg_qsyylr.png",
    resinImg: "https://res.cloudinary.com/dzvwqhzgf/image/upload/v1761302010/Epoxy_Filler_pjag7y.png",
    fillerImg: "https://res.cloudinary.com/dzvwqhzgf/image/upload/v1761302010/Epoxy_Filler_pjag7y.png",
...

  {
    ...
    image: "https://res.cloudinary.com/dzvwqhzgf/image/upload/v1761303433/5_Kg_bucket_a3ills.png",
    hardnerImg: "https://res.cloudinary.com/dzvwqhzgf/image/upload/v1761303338/Hardner_5_Kg_havox5.png",
    resinImg: "https://res.cloudinary.com/dzvwqhzgf/image/upload/v1761303359/Resin_5_Kg_x6e9ys.png",
    fillerImg: "https://res.cloudinary.com/dzvwqhzgf/image/upload/v1761302010/Epoxy_Filler_pjag7y.png",
...
export const tileGrout = [
  {
    ...
    slug: "tile-grout",
    description: "GeoGres Tile Grout is a polymer based un sanded cement grout. It is a fine, high quality grout mortar for tile and stone joints of 1 to 6 mm width on wall and floor.",
    ...
    scope: "The addition of GeoGres Grout Hardener to cement base GeoGres TILE GROUT will enhance adhesion to tile/stone edges, water resistance, improved flexibility and reduces the water permeability of the grout. Mix 300 ml of GeoGres Grout Hardener in 1kg GeoGres TILE Grout and mix until we get the lump free smooth paste.",
  }
]
...
export const groutGlitter = [
  {
    ...
    image: "https://res.cloudinary.com/dzvwqhzgf/image/upload/v1761301914/Glitter_c4eic1.png",
    slug: "epoxy-grout-glitter",
    description: "GeoGres Glitter are specially designed to be used as an additive and metalized effect and enhance the beauty of tiling area. It should be mixed with epoxy-based tile grout to get sparkling joints. It is recommended to use in internal & external areas under wet & dry conditions on wall & floor.",
    colours: "Gold, Silver, Copper",
    packaging: "100 gm bottle",
    dose: "50 gm in 1kg of GeoGres PREMIUM EPOXY GROUT",
...
export const groutHardner = [
  {
    ...
    image: "https://res.cloudinary.com/dzvwqhzgf/image/upload/v1761301961/Grout_Hardner_xp65lh.png",
    slug: "grout-hardener",

    description: "GeoGres Grout Hardener is a synthetic polymer emulsion additive to use with cement based grout such as Cement Grout for tile/stone joint grouting works. It improves the adhesion strength to tiles/stones, abrasion resistance, flexibility and reduces the water permeability of the cement grouts.",
...
export const TileCleaner = [
  {
    id: 1,
    name: "TILE CLEANER",
    image: "https://res.cloudinary.com/dzvwqhzgf/image/upload/v1761301938/tile_cleaner_v6iyoq.png",
    slug: "tile-cleaner",
    description: "GeoGres TILE CLEANER is powerful, fast acting, heavy duty Hydrochloric based cleaner for regular cleaning of dirt and stains on tile surfaces, designed for daily maintenance of tiles. It may also be used as general-purpose cleaner on other acid resistant surface. It is designed for removal of cement residues, efflorescence and most oxide stains",
...
export const BlockAdhesive = [
  {
    ...
    image: "https://res.cloudinary.com/dzvwqhzgf/image/upload/v1761302114/block-adhesive_qtkcol.png",
    slug: "block-adhesive",

    description: "GeoGres BLOCK ADHESIVE is a pre-mixed cementitious powder adhesive composed of Portland cement, hydraulic binders, bonding agents, silica sand and special adhesives. It is formulated as a crack free, superior, flexible, high bonding adhesive for AAC Blocks. It can also be used to fix Concrete, Cement blocks, Siporex Blocks and clay bricks to prevent clay absorption of water for adhesive mix. It is a masonry mortar for use in laying bricks, block. When mixed with water, GeoGres BLOCK ADHESIVE produces a workable mortar that generates, once cured, a high adhesive power between blocks.",
    ...
    scope: "GeoGres BLOCK ADHESIVE is specially designed for bonding AAC panels. It can also be used for laying Autoclaved Aerated Concrete blocks and clay bricks for internal and external application",
...
export const grout2k = [
  {
    id : 1,
    name: "2k GROUT",
    image: "https://res.cloudinary.com/dzvwqhzgf/image/upload/v1761302429/6_pbmfdr.png",
    slug: "2k-grout",
...
export const discoverSolutions = [
  {
    ...
    recommendedImg1: "https://res.cloudinary.com/dzvwqhzgf/image/upload/v1761302110/G-21_ypcger.png",
    recommendedImg2: "https://res.cloudinary.com/dzvwqhzgf/image/upload/v1761302004/G-31_hbt9km.png",
    recommendedbutton1slug: "products/polymer-modified",
    recommendedbutton2slug:  "products/polymer-modified-tile"
  },

  {
    ...
    recommendedImg1: "https://res.cloudinary.com/dzvwqhzgf/image/upload/v1761301927/G-11_id8llm.png",
    recommendedbutton1slug: "products/ceramic-tile",
  },

  {
    ...
    benefits1: " GeoGres G-41 & G-51 Tile Adhesive  - Excellent adhesion - Anti-slip - Accommodates bends ",
...

  {
    ...
    recommendedSol: "Fill Tile Joints With GeoGres Epoxy Grout and Sparkles",
    recommendedImg1: "https://res.cloudinary.com/dzvwqhzgf/image/upload/v1761303434/1_Kg_bucket_ndbezw.png",
    recommendedImg2: "https://res.cloudinary.com/dzvwqhzgf/image/upload/v1761301914/Glitter_c4eic1.png",
    recommendedbutton1slug: "products/epoxy-grout-1kg",
    recommendedbutton2slug: "products/epoxy-grout-glitter",
  ...
  },
  {
    ...
    recommendedImg1: "https://res.cloudinary.com/dzvwqhzgf/image/upload/v1761301938/tile_cleaner_v6iyoq.png",
    recommendedbutton1slug: "products/tile-cleaner",
  },
