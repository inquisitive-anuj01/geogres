...
const AboutUs = () => {
  return (
    <section className="bg-[#e6dcd5] text-black py-16 px-6 md:px-20 relative z-40 mb-10">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="bg-[#ccb9ad] p-6 rounded-2xl shadow-lg hover:shadow-xl transition ">
