    ...
    <section className="bg-[#e6dcd5] text-black py-16 px-6 md:px-20 relative mb-10 mt-20">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <h2 className="text-2xl font-bold text-black mt-8 mb-4">3. How We Protect Your Information</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-black mt-8 mb-4">4. Sharing Your Personal Information</h2>
          <p>
            We do not sell, trade, or rent your personal identification information to others. We may share generic aggregated demographic information not linked to any personal identification information regarding visitors and users with our business partners, trusted affiliates and advertisers.
          </p>
          
          <h2 className="text-2xl font-bold text-black mt-8 mb-4">5. Your Acceptance of These Terms</h2>
          <p>
