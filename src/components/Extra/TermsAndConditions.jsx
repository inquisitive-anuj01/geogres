  ...
  return (
    <section className="bg-[#e6dcd5] text-black py-16 px-6 md:px-20 relative mb-10">
      <div className="max-w-6xl mx-auto">
        ...
        >
          Terms & <span className="text-[#E5A025]">Conditions</span>
        ...
        >
          ...
          <h2 className="text-2xl font-bold text-black mt-8 mb-4">3. Links to Other Websites</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-black mt-8 mb-4">4. Disclaimer</h2>
          <p>
